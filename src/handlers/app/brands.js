...
// GET ONE RECORD
app.get('/app/:oms_public_key/merchant-groups/:merchant_group_id/brands/:id', verifyAppToken, async (req, res, next) => {
...
// GET RECORDS
app.get('/app/:oms_public_key/merchant-groups/:merchant_group_id/brands', verifyAppToken, async (req, res, next) => {
