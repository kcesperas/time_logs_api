...
// GET ONE RECORD
app.get('/public/:oms_public_key/merchant-groups/:id', verifyPublicToken, async (req, res, next) => {
...
// GET RECORDS
app.get('/public/:oms_public_key/merchant-groups', verifyPublicToken, async (req, res, next) => {
