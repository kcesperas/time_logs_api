...
let storeChargeSchema = require('../schemas/store-charge-schema.json');
module.exports = {
    ...
    save: async function(params) {
        ...
        try {
            let query = `
                INSERT INTO store_charges (${params.insertSql.INSERT}) 
    ...
    prepareUpdate:  async function(params) {
        ...
        for ( colname in columns) {
            if ( !storeChargeSchema.updateColums.includes(colname) )
            continue;
    ...
    prepareSave:  async function(params) {
        ...
        for ( colname in columns) {
            if ( !storeChargeSchema.createColums.includes(colname) )
            continue;
