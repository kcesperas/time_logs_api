...
let storeConfigchema = require('../schemas/store-config-schema.json');
module.exports = {
    ...
    save: async function(params) {
        ...
        try {
            let query = `
                INSERT INTO store_configs (${params.insertSql.INSERT}) 
    ...
    prepareUpdate:  async function(params) {
        ...
        for ( colname in columns) {
            if ( !storeConfigchema.updateColums.includes(colname) )
            continue;
    ...
    prepareSave:  async function(params) {
        ...
        for ( colname in columns) {
            if ( !storeConfigchema.createColums.includes(colname) )
            continue;
