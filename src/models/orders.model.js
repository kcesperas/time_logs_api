...
let ordersschema = require('../schemas/orders-schema.json');
...
class OrderModel extends CoreModel {
    ...
    static async save(params) {
        ...
        try {
            let query = `INSERT INTO orders (${params.insertSql.INSERT}) VALUES(${params.insertSql.VALUES})`;
    ...
    static async prepareUpdate(params) {
        ...
        console.log('params.currentorders', params.currentorders)
        for (let colname in columns) {
            if ( !ordersschema.updateColums.includes(colname) )
            continue;
    ...
    static async prepareSave(params) {
        ...
        for (let colname in columns) {
            if ( !ordersschema.createColums.includes(colname) )
            continue;
