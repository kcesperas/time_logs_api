...
class Order_itemModel extends CoreModel {
    ...
    static async save(params) {
        ...
        try {
            let query = `INSERT INTO order_items (${params.insertSql.INSERT}) VALUES(${params.insertSql.VALUES})`;
    ...
    static async getModelName() {
        return "Order_items Model"
    }


}

module.exports = Order_itemModel