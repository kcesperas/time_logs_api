...
let storeScheduleSchema = require('../schemas/store-schedule-schema.json');
module.exports = {
    ...
    save: async function(params) {
        ...
        try {
            let query = `
                INSERT INTO store_schedules (${params.insertSql.INSERT}) 
    ...
    prepareUpdate:  async function(params) {
        ...
        for ( colname in columns) {
            if ( !storeScheduleSchema.updateColums.includes(colname) )
            continue;
    ...
    prepareSave:  async function(params) {
        ...
        for ( colname in columns) {
            if ( !storeScheduleSchema.createColums.includes(colname) )
            continue;
